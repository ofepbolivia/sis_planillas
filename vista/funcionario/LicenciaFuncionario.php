...
<script>
    Phx.vista.LicenciaFuncionario=Ext.extend(Phx.gridInterfaz,{
        viewConfig: {
            stripeRows: false,
        ...
        constructor: function(config) {
            ...
            Phx.vista.LicenciaFuncionario.superclass.constructor.call(this,config);
            this.maestro = config;
        ...
        iniciarEventos: function(){
            ...
            this.gestion.on('select', function (combo,rec,index) {
                var record = this.getSelectedData(); console.log('select ', this.gestion.getRawValue(), this.maestro.maestro.id_funcionario);
        ...
        Atributos:[
...

            {
                ...
                type:'DateField',
                filters: {pfiltro: 'tli.desde', type: 'date'},
                id_grupo:1,
                grid:true,
                form:false
            },

            {
                ...
                type:'DateField',
                filters: {pfiltro: 'tli.hasta', type: 'date'},
                id_grupo:1,
                grid:true,
                form:false
            }
        ...
        ActList:'../../sis_planillas/control/HorasTrabajadas/listarLicenciaFuncionario',
